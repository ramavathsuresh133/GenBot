...
UI_LABELS = {
    ...
    "btn_download_summary_pdf": {
        "English":   "📄 Download Summary as PDF",
        "Hindi":     "📄 सारांश PDF डाउनलोड करें",
        "Telugu":    "📄 సారాంశం PDF గా డౌన్‌లోడ్ చేయండి",
        "Tamil":     "📄 சுருக்கத்தை PDF ஆக பதிவிறக்கவும்",
        "Kannada":   "📄 ಸಾರಾಂಶವನ್ನು PDF ಆಗಿ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ",
        "Malayalam":  "📄 സംഗ്രഹം PDF ആയി ഡൗൺലോഡ് ചെയ്യുക",
    },

    "btn_download_compare_pdf": {
        "English":   "📄 Download Comparison Report (PDF)",
        "Hindi":     "📄 तुलना रिपोर्ट डाउनलोड करें (PDF)",
        "Telugu":    "📄 పోలిక నివేదిక డౌన్‌లోడ్ చేయండి (PDF)",
        "Tamil":     "📄 ஒப்பீட்டு அறிக்கையை பதிவிறக்கவும் (PDF)",
        "Kannada":   "📄 ಹೋಲಿಕೆ ವರದಿ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ (PDF)",
        "Malayalam":  "📄 താരതമ്യ റിപ്പോർട്ട് ഡൗൺലോഡ് ചെയ്യുക (PDF)",
    },

    "btn_download_bias_pdf": {
        "English":   "📄 Download Bias Analysis (PDF)",
        "Hindi":     "📄 पूर्वाग्रह विश्लेषण डाउनलोड करें (PDF)",
        "Telugu":    "📄 పక్షపాత విశ్లేషణ డౌన్‌లోడ్ చేయండి (PDF)",
        "Tamil":     "📄 சார்பு பகுப்பாய்வை பதிவிறக்கவும் (PDF)",
        "Kannada":   "📄 ಪಕ್ಷಪಾತ ವಿಶ್ಲೇಷಣೆ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ (PDF)",
        "Malayalam":  "📄 പക്ഷപാത വിശകലനം ഡൗൺലോഡ് ചെയ്യുക (PDF)",
    },
    ...
    "ledger_tokens": {
        "English":   "Token Count",
        "Hindi":     "टोकन संख्या",
        "Telugu":    "టోకెన్ల సంఖ్య",
        "Tamil":     "டோக்கன் எண்ணிக்கை",
        "Kannada":   "ಟೋಕನ್ ಸಂಖ್ಯೆ",
        "Malayalam":  "ടോക്കണുകളുടെ എണ്ണം",
    },
    "ledger_metrics": {
        "English":   "Metrics",
        "Hindi":     "मीट्रिक",
    ...
    "ledger_results": {
        ...
        "Hindi":     "परिणाम सारांश",
        "Telugu":    "ఫలితాల సారాంశం",
        "Tamil":     "முடிவு சுருக்கம்",
        "Kannada":   "ಫಲಿತಾಂಶದ ಸಾರಾಂಶ",
        "Malayalam":  "ഫല സംഗ്രഹം",
    },
    "ledger_action": {
        "English":   "Action",
        "Hindi":     "कार्रवाई",
